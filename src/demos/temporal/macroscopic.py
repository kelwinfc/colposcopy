...
class MacroscopicResults(wx.Panel):
    ...
    def setLayout(self, extra_values=[]):
        ...
        self.length = TextField(self, wx.ID_ANY, label="Size (cm)",
                                default="0",
                                label_size=(0.08 * self.width - 10, -1),
                                text_size=(0.10 * self.width, -1),
                                style=wx.TE_RIGHT)
        self.rthird.Add(self.length, 0, wx.ALL, 0)
        
        self.cervix = Cervix(self, name="macroscopic")
        self.middle.Add(self.cervix, 0, wx.ALL, 0)
        self.right.Add(self.rfirst, 0, wx.ALL, 5)
        self.right.Add(self.rsecond, 0, wx.ALL, 5)
        self.right.Add(self.rthird, 0, wx.ALL, 0)
